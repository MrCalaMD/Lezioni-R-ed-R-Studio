...
Lo [script utilizzato](github.com/DoctorFrancescoCalabrese/Lezioni-R-ed-R-Studio/blob/main/Script/script_Lezione_3.R) funziona esclusivamente se il Dataframe di partenza è salvato nella stessa *directory* (cartella) nella quale si sta lavorando.<br>
